...
Public selectingSongs, Flag, FlagSpace As Boolean
...
On Error Resume Next
    ...
    b = GetPixel(hSrcDC, 30, 400) '检测选择歌曲颜色
    ...
    If (c = 537304 Or c = 1982180) And Flag = True Then
    ...
    If t > 50 Then
        ...
        t = 0
    End If
    If d = 5211047 And FlagSpace = True Then
        Form1.space
        FlagSpace = False
        t = 0
    End If
